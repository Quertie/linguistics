...
export default function LongShortDoubleO()
{
    return (
        <main>
            ...
            <ul>
                <li>The [ʊ] sound<br/>
                    It is <strong>short</strong>, and its realization depends on the speaker&apos;s accent.<br/>
                ...
                <li>The [u:] sound<br />
                    ...
                    Speakers of SSB English use a sound often transcribed as [ᵾw], that could be approximated with an [øy] (<i>jeu</i> / <i>rue</i>).
                </li>
            </ul>
            <h2>Examples</h2>
                <ul>
                    ...
                    <li>The [u:] sound
                        <ul>
                            <li><Example Text='Who' /></li>
                            <li><Example Text='Mood' /></li>
                            <li><Example Text='Blue' /></li>
                            <li><Example Text='Shoe' /></li>
                            <li><Example Text='Goose' /></li>
                            <li><Example Text='Menu' /></li>
                            <li><Example Text='Moon' /></li>
                            <li><Example Text='Food' /></li>
                            <li><Example Text='Move' /></li>
                            <li><Example Text='True' /></li>
                        </ul>
                    </li>
